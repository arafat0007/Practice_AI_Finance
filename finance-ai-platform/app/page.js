  ...
  return (
    <div className="mt-40">
      ...
      <section className="py-20">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-12">Everything You Need to Manage About Finances</h2>
      ...
      <section className="py-20 bg-blue-600">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join us today and start your journey towards financial freedom.</p>
              <Link href="/dashboard">
